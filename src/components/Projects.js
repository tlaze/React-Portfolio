        ...
        <div className="container-fluid my-5" >
            <div className="row">
                ...
                <div className="project col-md-4 offset-md-2 my-3" id="project4">
                        <a href="https://tlaze.github.io/weather-dashboard/" target="blank" rel="noreferrer"><h4 className="projectTitle text-center">Deployed Application</h4></a>
                    ...
                    <div className="col-md-4 offset-md-1 my-3 text-center">
                        ...
                        <h6>This weather application powered by OpenWeatherOneAPI. Users can effortlessly search any city to access real-time weather and a 5-day forecast. Previous searches are saved for easy access. Accurate and reliable data for a seamless weather experience.
                        </h6>
                ...
                <div className="row">
                    <div className="project col-md-4 offset-md-2 my-3" id="project1">
                        <a href="https://tom-blog-ad9726927b47.herokuapp.com/" target="blank" rel="noreferrer"><h4 className="projectTitle text-center">Deployed Application</h4></a>
                    ...
                    <div className="col-md-4 offset-md-1 my-3 text-center">
                        ...
                        <h6>This project showcases a social media application with user authentication and key features like post creation, editing, and deletion, along with commenting on others' posts. The application utilizes sessions for data tracking and implements an automatic logout system after periods of inactivity, ensuring security and user convenience.
                        </h6>
                        <h4>Technology Used</h4>
                        <ul type="none">
                            <li>HTML</li>
                    ...
                    <div className="project col-md-4 offset-md-2 my-3" id="project3">
                        <a href="https://tlaze.github.io/password-generator/" target="blank" rel="noreferrer"><h4 className="projectTitle text-center">Deployed Application</h4></a>
                    ...
                    <div className="project col-md-4 offset-md-2 my-3" id="project5">
                        <a href="https://caitlinw29.github.io/pokeBattle/" target="blank" rel="noreferrer"><h4 className="projectTitle text-center">Deployed Application</h4></a>
                    ...
                    <div className="col-md-4 offset-md-1 my-3 text-center">
                        ...
                        <h6>This 4 member project allows users to relive childhood nostalgia by battling 1st Generation Pokemon.
                            ...
                            My responsibilties included retrieving each Pokemon's moves and applying to each attack button.
                        </h6>
                        <h4>Technology Used</h4>
                        <ul type="none">
                            <li>HTML</li>
